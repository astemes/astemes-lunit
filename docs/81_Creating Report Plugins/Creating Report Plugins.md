...
Plugins made for earlier versions of the framework needs to be updated to adhere to the new design, please see section below.
...
- Renmae `LUnit Handle Result.vi` to `LUnit Result.vi`
